...
import static io.server.AppiumServerManager.*;
...
public class IOSDriverManager {
    ...
    private static final String APP_PATH = String.valueOf(Path.of(System.getProperty("user.dir"), "/src/test/resources/app/Debug-iphonesimulator-date-picker/", "App.app"));
